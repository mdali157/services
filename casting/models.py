...
class Flask(models.Model):
    ...
    input_weight = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    output_weight = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    machine_wastage = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    production_weight = models.CharField(max_length=158 ,default='0',blank=True, null=True)
...
class Casting(models.Model):
    ...
    weight = models.CharField(max_length=158 ,default='0', blank=True, null=True)
    converted24k = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    wastage_percentage = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    wastage_weight = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    total_weight24k = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    gold_received = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    service_charges_rate = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    service_charges_amount = models.CharField(max_length=158 ,default='0',blank=True, null=True)
    cash_received = models.CharField(max_length=158 ,default='0',blank=True, null=True)
